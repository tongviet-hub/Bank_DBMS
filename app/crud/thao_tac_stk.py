...
from schemas import ThaoTacSoTietKiemBase, ThaoTacSoTietKiem



def create_thao_tac_so_tiet_kiem(db: Session, thao_tac_so_tiet_kiem: ThaoTacSoTietKiem):
...
def get_thao_tac_so_tiet_kiem(db: Session, thao_tac_so_tiet_kiem_id: str = None, thao_tac_so_tiet_kiem_name: str = None):
...
def get_all_thao_tac_so_tiet_kiem(db: Session):
    ...
    """
    return db.query(Thao_tac_so_tiet_kiem).order_by(Thao_tac_so_tiet_kiem.id).all()

def delete_thao_tac_so_tiet_kiem(db: Session, thao_tac_so_tiet_kiem_id: str = None, thao_tac_so_tiet_kiem_name: str = None):
    """
...
def update_thao_tac_so_tiet_kiem(db: Session, thao_tac_so_tiet_kiem_id: str, thao_tac_so_tiet_kiem: ThaoTacSoTietKiemBase):
    db_thao_tac_so_tiet_kiem = db.query(Thao_tac_so_tiet_kiem).filter(Thao_tac_so_tiet_kiem.id == thao_tac_so_tiet_kiem_id).first()
    if db_thao_tac_so_tiet_kiem is None:
        raise HTTPException(status_code=404, detail="Thao tác sổ tiết kiệm không tồn tại")
