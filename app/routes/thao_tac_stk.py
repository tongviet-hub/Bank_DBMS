...
@router.get("/thao-tac-stk/", response_model=list[schemas.ThaoTacSoTietKiem])
...
@router.post("/thao-tac-stk/", response_model=schemas.ThaoTacSoTietKiem)
...
@router.get("/thao-tac-stk/{thao_tac_stk_id}", response_model=schemas.ThaoTacSoTietKiem)
def get_thao_tac_stk(thao_tac_stk_id: str, db: Session = Depends(get_db)):
...
def delete_thao_tac_stk(thao_tac_stk_id: str, db: Session = Depends(get_db)):
    """Xóa thao tác sổ tiết kiệm theo ID"""
    return crud.delete_thao_tac_so_tiet_kiem(db=db, thao_tac_so_tiet_kiem_id=thao_tac_stk_id)

@router.put("/thao-tac-stk/{thao_tac_stk_id}", response_model=schemas.ThaoTacSoTietKiem)
def update_thao_tac_stk(thao_tac_stk_id: str, thao_tac_stk: schemas.ThaoTacSoTietKiemCreate, db: Session = Depends(get_db)):
